...
struct GlareView: View {
    ...
    var body: some View {
        GeometryReader { geometry in
            ...
            Rectangle()
                .fill(Color.white.opacity(scheme == .light ? oppacity : oppacity))
        ...
        /// Change so that it constantly animates
...
@available(iOS 13.0, *)
extension View {
    public func shineEffect(animationTrigger: Binding<Bool>) -> some View {
